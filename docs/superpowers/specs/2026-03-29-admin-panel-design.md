...
Сейчас сервер принимает один `-key` флаг — все клиенты используют один ключ. Нужно: поддержка нескольких юзеров с несколькими девайсами у каждого, веб-админка для управления на `proxyness.smurov.com/admin`.
